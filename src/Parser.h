  ...
  private:
    ParsedField* ParseField(tll::scheme::Field* field, const std::string& beforeTag)
    {
        ...
        if (TryParseEnumType(field, parsedField)) {
            return parsedField;
        } else if (TryParseStringType(field, parsedField)){
            return parsedField;
        } else if (TryParseTimePointType(field, parsedField)){
            return parsedField;
        } else if (TryParseDurationType(field, parsedField)){
            return parsedField;
        } else if (TryParseFixedType(field, parsedField)){
            return parsedField;
        } else if (TryParseBitsType(field, parsedField)){
            return parsedField;
        } else if (TryParseDecimal128Type(field, parsedField)){
            return parsedField;
        } else if (TryParseBytesType(field, parsedField)){
            return parsedField;
        } else if (TryParseMessageType(field, parsedField, beforeTag)){
            return parsedField;
        } else if (TryParseArrayType(field, parsedField)){
            return parsedField;
        } else if (TryParseStringPointerType(field, parsedField)) {
            return parsedField;
        } else if (TryParsePointerType(field, parsedField)){
            return parsedField;
        } else if (TryParseUnionType(field, parsedField)){
            return parsedField;
        } else if (TryParsePrimitiveType(field, parsedField)){
            return parsedField;
        }
    ...
    bool TryParseStringPointerType(tll::scheme::Field* field, ParsedField* parsedField)
    {
        ...
        parsedField->isStringPointer = true;
    ...
    bool TryParsePrimitiveType(tll::scheme::Field* field, ParsedField* parsedField)
    {
        ...
        const auto ws_base = IsIntegerType(field->type) ? BASE_DEC : BASE_NONE;
